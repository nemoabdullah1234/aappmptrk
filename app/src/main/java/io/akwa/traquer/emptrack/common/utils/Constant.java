...
public class Constant {
    ...
    public static final String COGNITO_USER_POOL_ID = "us-west-2_XUUjby6xT";
    public static final String COGNITO_CLIENT_ID = "a25tbph1trm7uqp37avsdlpnu";
    public static final String CLIENT_ID = "012179919676";
    public static final String PROJECT_ID = "us-west-2_XUUjby6xT";
